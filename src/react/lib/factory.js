 ...
 * @param {object|function} [options.overrideProps={}] Override props object
 *                          or function (called with regular props)
 * @param {boolean} [options.autoGenerateKey=true] Whether or not automatic
...
export function createShorthand(Component, mapValueToProps, val, options = {}) {
  ...
  if (valIsFunction) return val(Component, props, children);
