import { ReactBucketComponentProps, SharedComponentStateProps, ShorthandItem } from '../../generic';
...
export interface PanelProps extends ReactBucketComponentProps<StrictPanelProps>, SharedComponentStateProps {
