...
export interface RxTableProps<Data>
  extends ReactBucketComponentProps<StrictRxTableProps<Data>, 'table'> {}
export interface StrictRxTableProps<Data>
  extends UseRxTableFactoryConfig<Data> {
...
/** Data Filtering */
export declare type RxColumnInputFilter<Data> = {
  initialValue?: string;
  type: 'input';
  props?: InputProps;
  show: (value: string, data: Data, index: number, array: Data[]) => boolean;
};
export declare type RxColumnCheckboxFilter<Data> = {
  initialValue?: boolean;
  type: 'checkbox';
  props?: CheckboxProps;
  show: (value: boolean, data: Data, index: number, array: Data[]) => boolean;
};
export declare type RxColumnSelectFilter<Data> = {
  initialValue?: string;
  type: 'select';
  props?: SelectProps;
  show: (value: string, data: Data, index: number, array: Data[]) => boolean;
};
export declare type RxTableDataFilter<Data> =
...
declare type ComputedCellContentField<Data> =
  | ((
      data: Data,
      index: number,
      array: Data[]
  ...
  | React.ReactNode;
/** Single Column */
export declare type RxTableColumnProps<Data, Props extends {} = {}> = Props &
  StrictRxTableColumnProps<Data>;
...
>;
export declare type RxTableFilterCellComponent = React.ComponentType<
  RxTableFilterCellProps & AnyObject
>;
export declare type RxTableErrorComponent = React.ComponentType<
  RxTableErrorProps & AnyObject
>;
