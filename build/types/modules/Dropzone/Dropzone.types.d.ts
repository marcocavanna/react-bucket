...
import { FontAwesomeIcon, ReactBucketIcon } from '../../generic';
...
export interface StrictDropzoneProps {
  ...
  iconOnDragging?: ReactBucketIcon<IconProps>;
  /** Set the hint icon on idle */
  iconOnIdle?: ReactBucketIcon<IconProps>;
...
export interface DropzoneHelpers {
  ...
  setFilesState: (
    files: DropzoneFile[],
    state: Partial<DropzoneFileState>
  ) => void;
}
