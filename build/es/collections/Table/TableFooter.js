...
var TableFooter = function (props) {
  ...
  var ElementType = customHook.useElementType(TableFooter, props);
  var classes = clsx__default['default'](className, 'foot');
...
TableFooter.create = reactUiCore.createShorthandFactory(TableFooter, function (
  content
) {
