 ...
 * Component Render
 * -------- */
var HeaderSubheader = function (props) {
  ...
  var ElementType = reactUiCore.getElementType(HeaderSubheader, props);
  var classes = clsx__default['default']('subheader', className);
...
HeaderSubheader.create = reactUiCore.createShorthandFactory(
  HeaderSubheader,
  function (content) {
...
module.exports = HeaderSubheader;
