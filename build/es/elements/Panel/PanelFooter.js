...
var PanelFooter = function (props) {
  ...
  var ElementType = customHook.useElementType(PanelFooter, props);
  var classes = clsx__default['default']('foot', className);
...
PanelFooter.create = reactUiCore.createShorthandFactory(PanelFooter, function (
  content
) {
