...
var ItemMeta = function (props) {
  ...
  var ElementType = customHook.useElementType(ItemMeta, props);
  /** Build the element class list */
  var classes = clsx__default['default']('item-meta', className);
...
ItemMeta.create = reactUiCore.createShorthandFactory(ItemMeta, function (
  content
) {
